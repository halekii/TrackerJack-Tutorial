...
After Effects Panel
#################
:ref:`Install<Installation>` the UI Panel-on and Open After Effects if you haven't already.

    .. image:: images/AE_1_tjpanel.png
        :alt: After Effects TrackerJack Panel
        
There are only two entries to make in order to export your camera tracked composition from After Effects
to a JSON file that the Blender TrackerJack add-on will import. The Focal Length and Angle of View which
